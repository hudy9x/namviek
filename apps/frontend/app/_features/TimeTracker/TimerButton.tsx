...
const TimerButton: React.FC<TimerButtonProps> = ({ taskId, taskName = '', disabled }) => {
  ...
  return (
    <div onClick={handleClick} className={`w-5 h-5 border rounded-md p-[5px] cursor-pointer ${isCurrentTaskRunning ? 'bg-red-500 border-red-500' : 'bg-white'}`}>
