...
type ConvertFieldsToString<T, Fields extends keyof T> = {
  ...
  : T[K] extends mongoose.Types.ObjectId | undefined ? string | undefined
  : T[K] extends (mongoose.Types.ObjectId)[] ? string[]
  : T[K]
  : T[K]
}
...
export const transformToId = (doc: any) => {
