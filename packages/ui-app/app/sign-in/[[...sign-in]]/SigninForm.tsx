...
export default function SigninForm() {
	...
	return <div className="sign-page h-screen w-screen flex items-center justify-center ">
		<div className="flex rounded-md border-2 border-indigo-300 shadow-2xl shadow-indigo-200">
			...
			<form onSubmit={regHandleSubmit} className="bg-white p-8 w-[350px] sm:w-[400px] rounded-md">
				...
				<div className="mt-6 text-center text-gray-400 text-sm">Don not have any account ? <Link className="text-indigo-600 hover:underline" href={"/sign-up"}>Register</Link></div>
