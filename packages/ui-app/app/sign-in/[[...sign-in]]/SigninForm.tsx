...
export default function SigninForm() {
  ...
  return (
    <div className="sign-page h-screen w-screen flex items-center justify-center ">
      <div className="flex rounded-xl border-4 border-indigo-300 dark:border-gray-800/50 ">
        <form
          onSubmit={regHandleSubmit}
          className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-md p-8 w-[350px] sm:w-[400px] rounded-md">
