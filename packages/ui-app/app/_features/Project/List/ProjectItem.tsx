...
export default function ProjectItem({ project, isArchived = false }: { project: Project, isArchived?: boolean }) {
  ...
  const createdAtString = createdAt
    ? dateFormat(new Date(createdAt), 'PP')
    : ''
  ...
  return <div
    ...
    <div className="project-item group relative">
      ...
      <div>
        ...
        <ProjectItemAction isArchived={isArchived} project={project} className="absolute top-5 right-3 opacity-0 group-hover:opacity-100" />
