        ...
        {views.map((view, vindex) => {
          ...
          return (
            <div
              ...
              <div className={`p-1 rounded-md ${classes} relative border-2`}>
                <img src={`/project-view/${view.img}.svg`} />
                {isSelected ? (
                  <span className="absolute top-1 right-1 text-[10px] p-1 rounded-full bg-gray-200 border w-5 h-5 flex items-center justify-center ">
                    {position + 1}
                  </span>
                ) : null}
              </div>
