	...
	return (
		<div className="sign-page h-screen w-screen flex items-center justify-center ">
			<div className="flex rounded-md border-2 border-indigo-300 shadow-2xl shadow-indigo-200">
				<div className={`w-[350px] sm:w-[400px] text-center p-8 rounded-md bg-white ${success ? '' : 'hidden'}`}>
				...
				<form onSubmit={regHandleSubmit} className={`${success ? 'hidden' : ''} bg-white p-8 w-[350px] sm:w-[400px] rounded-md`}>
					<div className="flex gap-2 items-center">
						<Logo />
						<h2 className="text-xl sm:text-2xl font-bold">Sign up to Kampuni</h2>
					</div>
					<p className="text-gray-400 text-sm mt-3">
